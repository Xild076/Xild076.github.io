...
site.add_blog_post("bias_types", "Programming - Types of Bias", "blogs/modern_media.md", author="Harry Yin", date="2025-03-12")
site.add_blog_post("fatalism", "Misc - My Thoughts on Fatalism", "blogs/fatalism.md", author="Harry Yin", date="2025-03-11")
site.add_blog_post("debias", "Programming - Removing Bias from Text", "blogs/bias_removal.md", author="Harry Yin", date="2025-03-10")
