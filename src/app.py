...
site.add_html_file_page("apush_timeline", "APUSH Timeline", "docs/apush_timeline.html")
...
with cool_stuff_page.Container(css_class="my_lg"):
    ...
    cool_stuff_page.Widget("APUSH Timeline", "Just finished the APUSH test, wanted to post this thing here.", link="docs/apush_timeline.html", image_url="/static/imgs/placeholder.png", animation=AnimationType.FADE_IN_LEFT, scroll_animation=True, scroll_animation_delay=0.15)
